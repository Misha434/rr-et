...
@section('content')
  <div class="container">
    ...
    <div class="row">
      <div class="col-12">
        <h1 class="text-center my-3">提案一覧</h1>
      </div>
    </div>
    <!-- Title End -->
      ...
      @foreach($proposals as $key => $proposal) 
        <div class="col-12">
          <div class="card mt-2 px-3 pt-3">
            <h4 class="text-center" data-e2e="proposal-{{ $key }}">{{ $proposal->name }}</h4>
            <div class="d-block">
              <div class="float-right">
                <!-- 削除ボタン Start -->
                  ...
                  >
                    ...
                    class="btn btn-danger btn-sm" data-e2e="proposal-{{ $key }}-delete"
                ...
                <!-- 採用ボタン Start -->
                  ...
                  >
                    ...
                    class="btn btn-primary btn-sm mr-2" data-e2e="proposal-{{ $key }}-aprove"
