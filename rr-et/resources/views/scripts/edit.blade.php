    ...
    <div class="col-12">
      <form action="{{ route('scripts.update', ['script' => $script]) }}" method="POST">
        ...
        <div class="form-group">
          ...
          <span class="badge badge-danger pt-1">※必須</span>
          <textarea class="form-control" id="content" rows="3" name="content">{{ old('content') ?? $script->content }}</textarea>
          <div class="text-right my-2">
            <button type="submit" class="btn btn-success" name="draft" data-e2e="submit">下書き</button>
